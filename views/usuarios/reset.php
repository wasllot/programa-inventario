							...
							<div class="col-lg-5 border-end">
								<div class="card-body">
									<div class="p-5">
										...
										<h4 class="mt-5 font-weight-bold">Crear Nueva Contraseña</h4>
										...
										<div class="mb-3 mt-5">
											...
											<input type="text" class="form-control" id="nueva_clave" placeholder="Ingrese Nueva Contraseña" />
										</div>
										<div class="mb-3">
										...
										<div class="d-grid gap-2">
											<button type="button" class="btn btn-primary" id="btnAccion">Cambiar Contraseña</button> <a href="<?php echo BASE_URL; ?>" class="btn btn-light"><i class='bx bx-arrow-back mr-1'></i>Volver al Inicio</a>
										</div>
									</div>
								</div>
							</div>
