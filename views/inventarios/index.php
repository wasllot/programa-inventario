    ...
    <div class="card-body">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-inventarios-tab" data-bs-toggle="tab" data-bs-target="#nav-inventarios" type="button" role="tab" aria-controls="nav-inventarios" aria-selected="true"><i class="fa-solid fa-file-lines"></i> Inventario</button>
                <button class="nav-link" id="nav-kardex-tab" data-bs-toggle="tab" data-bs-target="#nav-kardex" type="button" role="tab" aria-controls="nav-kardex" aria-selected="false"><i class="fa-solid fa-file-lines"></i> Kardex</button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-inventarios" role="tabpanel" aria-labelledby="nav-inventarios-tab" tabindex="0">
                ...
                <label for="mes">Fecha Inventario</label>
            ...
            <div class="tab-pane fade p-3" id="nav-kardex" role="tabpanel" aria-labelledby="nav-kardex-tab" tabindex="0">
                ...
                <div class="input-group mb-2" id="containerCodigo">
                    ...
                    <input class="form-control" type="text" id="buscarProductoCodigo" placeholder="Ingrese Barcode - Enter" maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required autocomplete="off">
                ...
                <div class="input-group d-none mb-2" id="containerNombre">
                    <span class="input-group-text"><i class="fas fa-search"></i></span>
                    <input class="form-control" type="text" id="buscarProductoNombre" placeholder="Buscar Producto" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="30" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" autocomplete="off">
                    <span class="input-group-text"><button class="btn btn-danger" type="button"><i class="fas fa-file-pdf"></i></button></span>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert border-0 border-start border-5 border-primary alert-dismissible fade show py-2">
                    <div class="d-flex align-items-center">
                        <div class="font-35 text-primary">
                        </div>
                        <div class="ms-3">
                            <h6 class="mb-0 text-primary">INGRESE NUMERO NEGATIVO SI DESEA DISMINUIR CANTIDAD</h6>
                            <hr>
                            <h6 class="mb-0 text-primary">INGRESE NUMERO POSITIVO SI DESEA AUMENTAR CANTIDAD</h6>
                        </div>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                ...
                <div class="input-group mb-2" id="containerCodigoAjuste">
                    <span class="input-group-text"><i class="fas fa-search"></i></span>
                    <input class="form-control" type="text" id="buscarCodigoAjuste" placeholder="Ingrese Barcode - Enter" maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required autocomplete="off">
                </div>

                <!-- input para buscar nombre -->
                <div class="input-group d-none mb-2" id="containerNombreAjuste">
                    <span class="input-group-text"><i class="fas fa-search"></i></span>
                    <input class="form-control" type="text" id="buscarNombreAjuste" placeholder="Buscar Producto" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="30" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" autocomplete="off">
                </div>
