    ...
    <div class="card-body">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-apartados-tab" data-bs-toggle="tab" data-bs-target="#nav-apartados" type="button" role="tab" aria-controls="nav-apartados" aria-selected="true">Productos Apartados</button>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active p-3" id="nav-apartados" role="tabpanel" aria-labelledby="nav-apartados-tab" tabindex="0">
                <h5 class="card-title text-center"><i class="fa-solid fa-boxes-packing"></i> Productos Apartados por los Clientes</h5>
                <hr>
                <div id='calendar'></div>
            ...
            <div class="modal-body">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                            <input class="form-control" type="number" step="0.01" min="0.01" id="abono" onkeypress="return SoloNumeros(event);" placeholder="Abono" required>
                        </div>
