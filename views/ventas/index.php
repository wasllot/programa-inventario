                ...
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="number" id="numCliente" placeholder="CI" disabled>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="number" id="descuento" onkeypress="return SoloNumeros(event);" maxlength="3" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Descuento" required>
                        </div>
