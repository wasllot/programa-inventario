...
<div class="card">
    <div class="card-body">
        ...
        <div class="d-flex align-items-center">
            <div>
                <h5 class="card-title text-center"><i class="fa-solid fa-cash-register"></i> Historial Cajas</h5>
            </div>
            <div class="dropdown ms-auto">
                ...
                <ul class="dropdown-menu">
                    <?php if (empty($data['caja'])) { ?>
                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalCaja"><i class="fa-solid fa-cash-register"></i> Abrir Caja</a>
                        </li>
                    <?php } else { ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-2">
                    <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                    <input class="form-control" type="number" id="monto_inicial" onkeypress="return SoloNumeros(event);" maxlength="3" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Monto Inicial">
                </div>
                <div class="d-grid">
