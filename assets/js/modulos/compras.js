...
//provedores
const rifProveedor = document.querySelector('#rifProveedor');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $("#buscarProveedor").autocomplete({
        ...
        select: function (event, ui) {
            rifProveedor.value = ui.item.rif;
                        ...
                        setTimeout(() => {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    const ruta = base_url + 'compras/reporte/ticket/' + res.idCompra;
...
function verReporte(idCompra) {
    Swal.fire({
        ...
        /* Read more about isConfirmed, isDenied below */
        if (result.isConfirmed) {
            const ruta = base_url + 'compras/reporte/ticket/' + idCompra;
            window.open(ruta, '_blank');
        } else if (result.isDenied) {
...
function anularCompra(idCompra) {
    Swal.fire({
        ...
        text: "El stock de los productos será modificado",
        icon: 'warning',
        showCancelButton: true,
