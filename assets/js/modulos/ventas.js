...
const numCliente = document.querySelector('#numCliente');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $("#buscarCliente").autocomplete({
        ...
        select: function (event, ui) {
            numCliente.value = ui.item.num_ci;
                        ...
                        setTimeout(() => {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    const ruta = base_url + 'ventas/reporte/ticket/' + res.idVenta;
...
function verReporte(idVenta) {
    Swal.fire({
        ...
        /* Read more about isConfirmed, isDenied below */
        if (result.isConfirmed) {
            const ruta = base_url + 'ventas/reporte/ticket/' + idVenta;
            window.open(ruta, '_blank');
        } else if (result.isDenied) {
...
function anularVenta(idVenta) {
    Swal.fire({
        ...
        text: "El stock de los productos cserá modificado!",
        icon: 'warning',
        showCancelButton: true,
