...
class ComprasModel extends Query{
    ...
    {
        $sql = "SELECT c.*, p.rif, p.nombre, p.telefono, p.direccion FROM compras c INNER JOIN proveedor p ON c.id_proveedor = p.id WHERE c.id = $idCompra";
        return $this->select($sql);
    }
    //actualizar stock}
    ...
    //movimientos para ser registrado en el inventario
